...
package com.lipisoft.toyshark.ConnectionAnalysis;



import android.util.Log;

import com.lipisoft.toyshark.Assistant.Const;
import com.lipisoft.toyshark.Assistant.ExecCom;
import com.lipisoft.toyshark.Assistant.TLType;
import com.lipisoft.toyshark.Assistant.ToolBox;
...
//        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(RunStore.getAppContext());
    ...
    private static void updateOrAdd(ArrayList<Report> reportList){
        Log.e("DEBUGDETECTOR", "updateOrAdd: " + reportList.size() );
